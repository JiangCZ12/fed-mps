...
def args_parser():
    ...
    # federated arguments   
    parser.add_argument('--epochs', type=int, default=30, help="rounds of training30")
    parser.add_argument('--set_epochs', type=list, default=100, help="list of training epochs")
    ...
    parser.add_argument('--local_ep', type=int, default=50, help="the number of local epochs: E50")
    ...
    parser.add_argument('--set_algo_type', type=list, default=['Fed-MPS','Fed-RDP'], help="The selected algorithm'Fed-MPS'")
